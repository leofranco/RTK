...
At that moment the server broke. It looks like it cannot have so many open connections. To redis for sure coming from the “dial tcp :6379: too many open files”
...
Response time:                 0.44 secs
Transaction rate:                536.67 trans/sec
Throughput:                    0.07 MB/sec
Concurrency:                 236.67
